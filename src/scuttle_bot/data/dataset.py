...
class Dataset(DatabaseClient):
    ...
    def create_dataset(self, region = Region.NA, queue = Queue.RANKED_SOLO_5x5, sample_size: int = 300, max_errors_in_a_row: int = 5, batch_size: int = 100):
...
if __name__ == "__main__":
    ...
    dataset.create_dataset(sample_size=300, batch_size=10)
